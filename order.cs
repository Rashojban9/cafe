...
namespace Bislerium_cafe
{
    public partial class order : Form
    {
        ...
        private const string ExcelPath = "C:\\Users\\rasho\\Desktop\\Application development\\staff_login_data.xlsx";
        ...
        private Panel CreateItemPanel(string itemName, string itemPrice, string imagePath)
        {
            ...
            pictureBox.Image = Image.FromFile("C:\\Users\\rasho\\Desktop\\Application development\\Bislerium cafe\\photo\\pngwing.com (1).png");
        ...
        private void SaveOrderToExcel()
        {
            using (var package = new ExcelPackage(new FileInfo(ExcelPath)))
            {
                ...
                {
                    worksheet.Cells[worksheet.Dimension.Rows + 1, 2].Value = orderedItem.ItemName;
                    worksheet.Cells[worksheet.Dimension.Rows + 1, 3].Value = orderedItem.ItemPrice;
                    worksheet.Cells[worksheet.Dimension.Rows + 1, 4].Value = orderedItem.Quantity;
                }
